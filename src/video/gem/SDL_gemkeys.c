...
/* ============================================================================
   SDL_gemkeys.c – Atari scancode to SDL scancode/keycode mapping
   Medour Mehdi - 2026
   Architecture: Motorola 68000 / Atari ST-TT-Falcon

   Provides a static lookup table mapping Atari hardware scancodes (0x00-0x53)
   to SDL_Scancode values, plus modifier state reading via BIOS Kbshift().
