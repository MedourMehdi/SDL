...
#elif defined(__MACOSX__) || defined(__MINT__) /* this is deprecated in 10.12 sdk; favor gcc atomics. */
...
#elif defined(__MINT__) || (defined(__MACOSX__) && !defined(__LP64__))  /* this is deprecated in 10.12 sdk; favor gcc atomics. */
